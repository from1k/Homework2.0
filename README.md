...
> *Примечание: первый commit был создан на основе сырого файла hello_world.cpp, который создвется после первого commit'а в лабораторной  работе. Проблем это вызвать не должно, они бы появились, если бы в проекте не было commit'ов в целом.* 
